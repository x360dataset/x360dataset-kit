...
def save_checkpoint(state, is_best, file_folder,
    ...
    print("=== save to:", os.path.join(file_folder, file_name))
...
def valid_one_epoch(
    ...
    for iter_idx, video_list in enumerate(val_loader, 0):
        ...
        with torch.no_grad():
            ...
            num_vids = len(output)
            for vid_idx in range(num_vids):   # length
                if output[vid_idx]['segments'].shape[0] > 0:
                    ...
                    # * 10
                    # print("ADDing shape:", output[vid_idx]['scores'].shape, 
                    #                        output[vid_idx]['segments'][:, 1].shape)
    ...
    # print("results in test utils:", results)
