...
def make_optimizer_tridet(model, optimizer_config):   
    from ..modeling.tridet import MaskedConv1D, Scale, AffineDropPath, LayerNorm 
    """create optimizer
...
def make_optimizer_actionformer(model, optimizer_config):   
    from ..modeling.actionformer import MaskedConv1D, Scale, AffineDropPath, LayerNorm 
    """create optimizer
    return a supported optimizer
    """
    # separate out all parameters that with / without weight decay
...
def make_optimizer_temporalmaxer(model, optimizer_config):
    from ..modeling.temporalmaxer import MaskedConv1D, Scale, LayerNorm
