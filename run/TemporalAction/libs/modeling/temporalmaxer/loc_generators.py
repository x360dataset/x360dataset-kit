# modify from https://github.com/happyharrycn/actionformer_release/blob/main/libs/modeling/loc_generators.py
...
@register_generator('point_temporalmaxer')
class PointGenerator(nn.Module):
    ...
    def _generate_points(self):
        ...
        for l, stride in enumerate(self.fpn_strides):
            ...
            points_list.append(
                torch.cat((points, reg_range, fpn_stride), dim=1))
