...
video_paths = '/bask/projects/j/jiaoj-3d-vision/Hao/360x/360data/360x_feat'


video_list = glob(os.path.join(video_paths, "audio/360", "*"))

os.makedirs("/bask/projects/j/jiaoj-3d-vision/Hao/360x/360data/360x_feat/audio_feat/360", exist_ok=True)
